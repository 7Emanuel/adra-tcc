      ...
      <nav className="container mx-auto px-4 py-4" role="navigation" aria-label="Navegação principal">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-adra-text">ADRA</span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button
              ...
              className="text-adra-text hover:text-adra-green transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-adra-green rounded px-2 py-1"
            >
              Início
            </button>
            <button
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg text-adra-text hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-adra-green"
        ...
        {isMenuOpen && (
          <div id="mobile-menu" className="md:hidden mt-4 pb-4 border-t border-gray-200 pt-4">
            <div className="flex flex-col space-y-3">
              <button
                onClick={() => scrollToSection('inicio')}
                className="text-left text-adra-text hover:text-adra-green transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-adra-green rounded px-2 py-2"
              >
                Início
              </button>
              <button
