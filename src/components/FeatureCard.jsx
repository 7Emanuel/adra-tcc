...
const FeatureCard = ({ icon, title, description, className = '' }) => {
  return (
    <div className={`bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-200 hover:-translate-y-1 ${className}`}>
      {/* Icon */}
      <div className="mb-4">
        <div className="w-12 h-12 bg-adra-green bg-opacity-10 rounded-xl flex items-center justify-center">
          {icon || (
      ...
      {/* Title */}
      <h3 className="text-xl font-bold text-adra-text mb-3">
        {title}
      </h3>

      {/* Description */}
      <div className="text-adra-text-secondary space-y-3">
